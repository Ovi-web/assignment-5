...
const StackSidebar: React.FC<StackSidebarProps> = ({
  ...
  return (
    <aside className="bg-white rounded-2xl border border-gray-200/90 p-5 sm:p-6 shadow-sm h-fit sticky top-24">
      {/* Header: Title, Counter & Remove All */}
      ...
      {/* Body: Empty State or 1-Column Item List */}
      {stack.length === 0 ? (
