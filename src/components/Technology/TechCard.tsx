...
const TechCard: React.FC<TechCardProps> = ({ tech, onAddToStack, isAdded }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between h-full">
      <div>
      ...
      <div>
        ...
        <button
          ...
          disabled={isAdded}
          className={`w-full py-2.5 px-4 rounded-lg text-xs sm:text-sm font-medium transition-all ${isAdded
